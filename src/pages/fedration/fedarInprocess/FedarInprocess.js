  ...
  const tableData = [
    {
      caseNumber: "472",
      branch:
        "दीनदयाळ नागरी सहकारी बँक मर्या. अंबाजोगाई (परळी रोड, शाखा-अंबाजोगाई )",
      name: "prakash",
      address: "Pune",
      mobile: "7774037519",
      status: "In Progress",
    ...
    {
      caseNumber: "473",
      branch: "	दि वाई अर्बन को-ऑप बँक लि.(सदाशिव पेठ, पुणे )",
      name: "mayur talole",
