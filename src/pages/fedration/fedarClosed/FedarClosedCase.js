...
function FedarClosedCase() {
  const [tableData] = useState([
    {
      caseNumber: "472",
      branch: "	वाई",
      name: "सुनील तुपे",
      address: "	३०,संकेश्वर रोड,शिवाजी स्टेडियम जवळ",
      mobile: "7774037519",
      ArName: "TestAR हवेली",
      status: "Closed",
    },
            ...
            >
              ...
              <div className="relative closed-dropdown-container mt-2">
                ...
                >
                  ...
                  <li
                    onClick={() => handleNavigate("/fedarclosereason")}
                    className="px-4 py-2 hover:bg-gray-100 cursor-pointer"
                  >
                    Case Closed Reason
                  </li>
                      ...
                      {openDropdownIndex === index && (
                        <div className="absolute right-0 bg-white border rounded shadow-lg mt-2 w-48 z-50">
                          <ul className="text-sm text-gray-700">
                            ...
                            <li
                              onClick={() =>
                                handleNavigate("/fedarclosereason")
                              }
                              className="px-4 py-2 hover:bg-gray-100 cursor-pointer"
                            >
                              Case Closed Reason
...
export default FedarClosedCase;
