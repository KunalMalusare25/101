  ...
  return (
    <div className="addnc-container">
      ...
      <div className="tab-content">
          ...
          <div className="tabcontent active">
            ...
            <form>
              <div className="form-row">
                ...
                <input type="text" value="JAL/RSR/CR/421/04 Date : 12/08/20" readOnly />
              </div>
              <div className="form-row">
                <label>बँक चे नाव</label>
                <select>
              ...
              <div className="form-row">
                <label>भंगजेचे नाव</label>
                <input type="text" value="देशपांडे विवेक" readOnly />
              </div>
              <div className="form-row">
                <label>सुनावणीस हजर राहण्यासाठी अधिकार असलेली प्राधिकृत व्यक्ती</label>
                <div>
                  <input type="radio" name="authority" value="manjur" /> मंजूर
                  <input type="radio" name="authority" value="adhikari" /> अधिकारी
                </div>
              </div>
              <div className="form-row">
        ...
        {activeTab === 'jamin' && <JaminInfo />} {/* Include the new JaminInfo component */}
