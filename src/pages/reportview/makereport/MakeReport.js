    ...
    <div className="font-sans p-5 max-w-4xl mx-auto border-black">
      ...
      <div className="flex flex-wrap gap-2 mt-5">
        {[
          ...
          { text: "चालन", color: "bg-orange-500", url: "" },
          {
          ...
          { text: "101 सेट - पूर्ण सेट", color: "bg-red-500", url: "" },
          { text: "101 सेट - नमुना ग", color: "bg-blue-500", url: "" },
          { text: "रजिस्टर पोष पार्सलिंग रसमस", color: "bg-blue-500", url: "" },
          { text: "101 सेट - नमुना क", color: "bg-blue-500", url: "" },
          { text: "101 सेट - रोजनामा", color: "bg-blue-500", url: "" },
          {
            text: "101 सेट - रोजनामा एक्स पार्टी",
            color: "bg-blue-500",
            url: "",
          },
          { text: "101 सेट - जबाब", color: "bg-blue-500", url: "" },
          { text: "101 सेट - ठराव", color: "bg-blue-500", url: "" },
          { text: "मागणी नोटीस (प्रकर 1)", color: "bg-red-500", url: "" },
          { text: "मागणी नोटीस (प्रकर 2)", color: "bg-red-500", url: "" },
          { text: "एक रुपया ठवक विशंती पत्र", color: "bg-green-500", url: "" },
          { text: "दोन रुपया ठवक विशंती पत्र", color: "bg-green-500", url: "" },
          { text: "तीन रुपया ठवक विशंती पत्र", color: "bg-green-500", url: "" },
          { text: "N1", color: "bg-yellow-200", url: "/notice-1" },
          { text: "N2", color: "bg-yellow-200", url: "" },
          { text: "N3", color: "bg-yellow-200", url: "" },
        ].map((btn, index) => (
          <button
            key={index}
