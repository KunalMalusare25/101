        ...
        <div className="mt-32 p-8 bg-white max-w-5xl mx-auto border border-gray-300 rounded-lg print:mt-0">
            ...
            <div className="print:text-sm">
                ...
                <div className="flex justify-between print:text-sm">
                    <p>नंबर - </p>
                    <p className="font-bold">एक हप्ता थकीत विनंती पत्र  </p> 
                    <p>शाखा – मुख्य शाखा</p> 
                </div>
                ...
                आपण संस्थेकडून व्यवसाय वाढीकारिता कर्ज घेतलेले आहे. त्याच्या १ हप्त्याएव्हढी रक्कम रुपये - 5100.00 थकली आहे. तरी पत्र मिळताच थकीत हप्त्याची रक्कम
